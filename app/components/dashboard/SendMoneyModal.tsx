...
import { ArrowUpRight, DollarSign, Phone, User, Wallet } from "lucide-react";
...
"
        >
            ...
            <form action="" className="w-full max-w-135.25 flex flex-col items-center justify-center px-7 py-8  gap-6
bg-linear-to-br from-[#020618] via-[#0F172B] to-[#162456]  " >
                ...
                <div className="w-fit flex flex-col items-center gap-5 " >
                    ...
                    <h3 className=" text-white text-2xl md:text-3xl font-bold tracking-wider mt-3 " >Send Money</h3>
                    <p className="text-sm md:text-base font-normal text-[#90A1B9]  " >Send crypto to any phone number via USSD</p>
                </div>
                ...
                <div className="w-full py-5 flex items-center  justify-between text-center bg-[#1624564D] border-[0.5px] border-[#193CB84D] rounded-[14px] px-6 text-sm md:text-base font-normal text-[#CAD5E2] " >
                    <p className="flex gap-2.5 items-center text-[#CAD5E2] font-normal text-sm  " ><Wallet size={20} color="#51A2FF" /> Available Balance</p>

                    <p className="text-base md:text-lg font-bold text-white " >$1,847.50 USDT</p>
                </div>
                ...
                <label htmlFor="note" className="w-full flex flex-col items-start gap-4 " >
                ...
                <Button
                    ...
                    Continue <ArrowUpRight size={17} /></Button>
            </form>
