...
export default function ConnectWalletPage() {
  const [currentStep, setCurrentStep] = useState(1); // Change the current step value to either 1, 2, or 3 to view the current step
        ...
        <div className=" w-full max-w-131.75 flex items-center flex-col gap-3 ">
          <div className=" size-16 md:size-25 bg-[linear-gradient(180deg,#155DFC_0%,#827AF2_135%)] rounded-[10px] md:rounded-[25px] flex items-center justify-center shadow-[0px_4px_7px_0px_#2B25AB40]  ">
            <Image
              ...
              height={300}
              width={300}
              className=" w-[39.5px] md:w-[58.5px] h-auto "
            />
          </div>
          <h2 className=" text-xl md:text-[40px] text-white font-bold  ">
            {" "}
            {stepTitle(currentStep)}{" "}
          </h2>
          <p className="text-[#90A1B9] font-normal text-base md:text-lg text-center ">
            {" "}
        ...
        <div className="w-full flex flex-col items-start gap-8  ">
          <div className=" flex flex-col items-center w-full gap-2 ">
            <div className=" w-full flex items-center justify-between gap-10 ">
              <small className=" text-[#90A1B9] text-sm font-normal ">
